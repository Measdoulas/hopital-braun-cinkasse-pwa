...
import { Save, Plus, Trash2, Settings, ToggleLeft, ToggleRight } from 'lucide-react';
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        {config.customOptions?.map((option) => (
                            <div key={option.id} className="flex flex-col md:flex-row gap-3 items-end md:items-center bg-neutral-50 p-3 rounded-md border">
                                <div className="flex-1 w-full">
                                    <label className="text-xs text-neutral-500 mb-1 block">Libellé</label>
                                    <Input
                                        value={option.label}
